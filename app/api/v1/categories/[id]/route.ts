...
/**
 * GET handler for retrieving a specific category by ID
 ...
 * @returns {Promise<Response>} JSON response with the requested category
 */
export const GET = async (
  ...
  if (!data) {
    return Response.json(apiError("Category not found"), { status: 404 })
  }
  return Response.json(
    apiSuccess({ ...data, id }, "Category retrieved successfully")
  )
}

/**
 * PATCH handler for updating a specific category by ID (partial update)
...
/**
 * PUT handler for updating a specific category by ID (full update)
 * @param {Request} request - The incoming request object containing update data
 * @param {Object} params - Route parameters containing the document ID
 * @param {Promise<{ id: string }>} params.params - Promise resolving to object with id string
 * @returns {Promise<Response>} JSON response indicating success or failure
...
/**
 * DELETE handler for removing a specific category by ID
 * @param {Request} _request - The incoming request object (unused)
 * @param {Object} params - Route parameters containing the document ID
 * @param {Promise<{ id: string }>} params.params - Promise resolving to object with id string
 * @returns {Promise<Response>} JSON response indicating success or failure
